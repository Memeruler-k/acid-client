...
public class AbnormallyModule extends BaseModule {
    public AbnormallyModule(Category category, String name, String description) {
    ...
    public void sendMsg(String string) {
        AChatUtils.sendMsg(Text.of(string));
    }
}
