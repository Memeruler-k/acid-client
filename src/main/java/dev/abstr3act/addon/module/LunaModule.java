...
public class LunaModule extends BaseModule {
    public LunaModule(Category category, String name, String description) {
    ...
    public void sendToggledMsg() {
        if (Config.get().chatFeedback.get() && this.chatFeedback && this.mc.world != null) {
            ...
            AChatUtils.sendMsgLuna(msg);
        }
    }

    public void sendMsg(String string) {
        AChatUtils.sendMsgLuna(Text.of(string));
    }
}
