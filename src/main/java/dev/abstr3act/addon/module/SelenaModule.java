...
public class SelenaModule extends BaseModule {
    public SelenaModule(Category category, String name, String description) {
    ...
    public void sendToggledMsg() {
        if (Config.get().chatFeedback.get() && this.chatFeedback && this.mc.world != null) {
            ...
            AChatUtils.sendMsgSelena(msg);
        }
    }

    public void sendMsg(String string) {
        AChatUtils.sendMsgSelena(Text.of(string));
    }
}
