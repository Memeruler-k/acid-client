...
public class SeraphimModule extends BaseModule {
    public SeraphimModule(Category category, String name, String description) {
    ...
    public void sendToggledMsg() {
        if (Config.get().chatFeedback.get() && this.chatFeedback && this.mc.world != null) {
            ...
            AChatUtils.sendMsgSeraphim(msg);
        }
    }

    public void sendMsg(String string) {
        AChatUtils.sendMsgSeraphim(Text.of(string));
    }
