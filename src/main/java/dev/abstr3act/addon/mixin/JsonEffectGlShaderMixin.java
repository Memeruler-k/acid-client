...
public abstract class JsonEffectGlShaderMixin implements SamplerAccess {
    ...
    private static Identifier constructProgramIdentifier(String arg, Operation<Identifier> original, ResourceFactory unused, Type shaderType, String id) {
        if (!arg.contains(":")) {
            return (Identifier) original.call(new Object[]{arg});
        } else {
