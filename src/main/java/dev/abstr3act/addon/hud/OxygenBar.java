...
public class OxygenBar extends HudElement {
    public static OxygenBar INSTANCE;    public static final HudElementInfo<OxygenBar> INFO = new HudElementInfo(dev.abstr3act.addon.Compassion.HUD_GROUP, "OxygenBar", ".", OxygenBar::new);
    ...
    public void render(HudRenderer renderer) {
        ...
        if (MeteorClient.mc.player != null) {
            float health = MeteorClient.mc.player.getAir();
            float maxHealth = MeteorClient.mc.player.getMaxAir();
