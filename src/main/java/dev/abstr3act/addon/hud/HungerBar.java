...
public class HungerBar extends HudElement {
    public static HungerBar INSTANCE;    public static final HudElementInfo<HungerBar> INFO = new HudElementInfo(dev.abstr3act.addon.Compassion.HUD_GROUP, "HungerBar", ".", HungerBar::new);
