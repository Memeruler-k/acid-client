...
public class UwUUtils {
    private static final String[] facesArray = new String[]{" (・`ω´・) ", " ;;w;; ", " OwO ", " UwU ", " >w< ", " ^w^ ", " ÚwÚ ", " ^-^ ", " :3 ", " x3 "};
    private static final String[] expressionArray = new String[]{" nyaa~~ ", " mya ", " rawr ", " rawr x3 ", " rawr XD", " XD ", " meow ", " meow~ "};
