...
public class TestKillAura extends AmritaModule {
    ...
    private final Setting<Double> rotationSpeed = this.sgGeneral
        .add(
            ((Builder) ((Builder) ((Builder) new Builder().name("MaxRotationSpeed")).description("."))
                .sliderRange(1.0, 180.0)
                .defaultValue(40.0)
                .visible(this.rotations::get))
                .build()
        );
    private final Setting<Double> rotationSpeed2 = this.sgGeneral
        .add(
            ((Builder) ((Builder) ((Builder) new Builder().name("MinRotationSpeed")).description("."))
                .sliderRange(1.0, 180.0)
                .defaultValue(20.0)
                .visible(this.rotations::get))
                .build()
    ...
    private final Setting<Double> speedFactor = this.sgGeneral
        .add(
            ((Builder) ((Builder) ((Builder) new Builder().name("SpeedFactor")).description("."))
                .sliderRange(0.01, 100.0)
                .defaultValue(10.0)
                .visible(this.rotations::get))
                .build()
        );
    private final Setting<Double> baseMax = this.sgGeneral
        .add(
            ((Builder) ((Builder) ((Builder) new Builder().name("BaseMaxOffset")).description("."))
                .sliderRange(1.0, 180.0)
                .defaultValue(0.0)
                .visible(this.rotations::get))
                .build()
        );
    private final Setting<Double> baseMin = this.sgGeneral
        .add(
            ((Builder) ((Builder) ((Builder) new Builder().name("BaseMinOffset")).description("."))
                .sliderRange(1.0, 180.0)
                .defaultValue(0.0)
                .visible(this.rotations::get))
                .build()
    ...
    private final Setting<Double> jitterValue = this.sgGeneral
        .add(
            ((Builder) ((Builder) ((Builder) new Builder().name("JitterValue")).description("."))
                .sliderRange(0.0, 20.0)
                .defaultValue(0.2)
                .visible(() -> this.rotations.get() && this.randomizedRotation.get()))
                .build()
        );
    private final Setting<Double> rotateMaxOffset = this.sgGeneral
        .add(
            ((Builder) ((Builder) ((Builder) new Builder().name("rotateMaxOffset")).description("."))
                .sliderRange(0.0, 100.0)
                .defaultValue(0.2)
                .visible(this.rotations::get))
                .build()
        );
    private final Setting<Double> rotateMinOffset = this.sgGeneral
        .add(
            ((Builder) ((Builder) ((Builder) new Builder().name("rotateMinOffset")).description("."))
                .sliderRange(0.0, 100.0)
                .defaultValue(0.1)
                .visible(this.rotations::get))
                .build()
    ...
    private final Setting<Double> targetHeightFactor = this.sgGeneral
        .add(
            ((Builder) ((Builder) ((Builder) new Builder().name("targetHeightFactor")).description("."))
                .sliderRange(0.01, 100.0)
                .defaultValue(2.0)
                .visible(this.rotations::get))
                .build()
    ...
    private final Setting<Double> randomAngleMin = this.sgGeneral
        .add(((Builder) ((Builder) new Builder().name("RandomAngleMin")).description(".")).sliderRange(-180.0, 180.0).defaultValue(40.0).build());
    private final Setting<Double> randomAngleMax = this.sgGeneral
        .add(((Builder) ((Builder) new Builder().name("RandomAngleMax")).description(".")).sliderRange(-180.0, 180.0).defaultValue(80.0).build());
    private final Setting<Double> randomChanceMin = this.sgGeneral
        .add(((Builder) ((Builder) new Builder().name("RandomChanceMin")).description(".")).sliderRange(1.0, 100.0).defaultValue(5.0).build());
    private final Setting<Double> randomChanceMax = this.sgGeneral
        .add(((Builder) ((Builder) new Builder().name("RandomChanceMax")).description(".")).sliderRange(1.0, 100.0).defaultValue(10.0).build());
    private final Setting<Boolean> rotateEaseIn = this.sgGeneral
        .add(
            ((meteordevelopment.meteorclient.settings.BoolSetting.Builder) ((meteordevelopment.meteorclient.settings.BoolSetting.Builder) ((meteordevelopment.meteorclient.settings.BoolSetting.Builder) new meteordevelopment.meteorclient.settings.BoolSetting.Builder()
                .name("RotateEaseIn"))
                .description("."))
    ...
    private final Setting<Boolean> rotateEaseOut = this.sgGeneral
        .add(
            ((meteordevelopment.meteorclient.settings.BoolSetting.Builder) ((meteordevelopment.meteorclient.settings.BoolSetting.Builder) ((meteordevelopment.meteorclient.settings.BoolSetting.Builder) new meteordevelopment.meteorclient.settings.BoolSetting.Builder()
                .name("RotateEaseOut"))
                .description("."))
    ...
    private final Setting<Double> yawOffset = this.sgGeneral
        .add(((Builder) ((Builder) new Builder().name("YawOffset")).description(".")).sliderRange(-5.0, 5.0).defaultValue(0.5).build());
    private final Setting<Double> pitchOffset = this.sgGeneral
        .add(((Builder) ((Builder) new Builder().name("PitchOffset")).description(".")).sliderRange(-5.0, 5.0).defaultValue(0.5).build());
    private final Setting<Double> yawFactor = this.sgGeneral
        .add(((Builder) ((Builder) new Builder().name("yawFactor")).description(".")).sliderRange(-5.0, 5.0).defaultValue(0.8).build());
    private final Setting<Double> pitchFactor = this.sgGeneral
        .add(((Builder) ((Builder) new Builder().name("pitchFactor")).description(".")).sliderRange(-5.0, 5.0).defaultValue(0.8).build());
    ...
    public TestKillAura() {
        super(Compassion.AMRITA, "TestKillAura", ".");
    }
                ...
                if (worldEntities.isEmpty()) {
                    ...
                    if (this.isWeapon(this.mc.player.getMainHandStack().getItem()) || !this.onlyWeapon.get()) {
                        if (this.rotations.get()) {
                            RotationUtil.aimAtEntity2(
                                closestEntity,
                                (this.rotationSpeed.get()).floatValue(),
                                (this.rotationSpeed2.get()).floatValue(),
                                (this.speedFactor.get()).floatValue(),
                                this.randomizedRotation.get(),
                                (this.baseMax.get()).floatValue(),
                                (this.baseMin.get()).floatValue(),
                                (this.jitterValue.get()).floatValue(),
                                (this.rotateMaxOffset.get()).floatValue(),
                                (this.rotateMinOffset.get()).floatValue(),
                                (this.maxDelay.get()).intValue(),
                                (this.minDelay.get()).intValue(),
                                (this.targetHeightFactor.get()).floatValue(),
                                (this.randomAngleMax.get()).floatValue(),
                                (this.randomAngleMin.get()).floatValue(),
                                (this.randomChanceMax.get()).floatValue(),
                                (this.randomChanceMin.get()).floatValue(),
                                this.rotateEaseIn.get(),
                                this.rotateEaseOut.get(),
                                (this.yawOffset.get()).floatValue(),
                                (this.pitchOffset.get()).floatValue(),
                                (this.yawFactor.get()).floatValue(),
                                (this.pitchFactor.get()).floatValue()
                            );
                        }
